<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('wordno1')); ?>:</b>
	<?php echo CHtml::encode($data->wordno1); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('wordno2')); ?>:</b>
	<?php echo CHtml::encode($data->wordno2); ?>
	<br />
