...
/**
 * This is the model class for table "tbl_profiles_fields".
 *
 * The followings are the available columns in table 'tbl_profiles_fields':
 * @property integer $id
 ...
 */
class TblProfilesFields extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return TblProfilesFields the static model class
	 */
